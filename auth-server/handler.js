...
const credentials = {
  ...
  redirect_uris: ["https://jenny-jny.github.io/meet_app/"],
  javascript_origins: ["https://jenny-jny.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents = async(event) => {
  ...
  //Decode access token code extracted from the URL query
  const access_token = decodeURIComponent(`${event.pathParameters.access_token}`);
  oAuth2Client.setCredentials({access_token});

  return new Promise((resolve, reject) => {
    //Exchange access token for calendar events with a “callback” after the exchange, 
